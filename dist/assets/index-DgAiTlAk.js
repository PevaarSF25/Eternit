const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/registroView-D-PPIHIG.js","assets/modal-DKrJSUEn.js","assets/parametricaService-CrC5YH-P.js","assets/formatter-BfxvljpV.js","assets/dashboardView-Ajrh6eKX.js","assets/parametricaView-DvYxXiue.js"])))=>i.map(i=>d[i]);
(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{label:`Dashboard`,icon:`bar-chart-2`,hash:`#dashboard`},{label:`Administración`,icon:`building-2`,isCollapse:!0,children:[{label:`Paramétricas`,hash:`#parametricas`}]},{label:`Registro`,icon:`clipboard-list`,isCollapse:!0,children:[{label:`General`,hash:`#registro-general`},{label:`Contratistas`,hash:`#registro-contratistas`}]}],t=!1;function n(){let e=document.getElementById(`sidebar`);if(!e){console.error(`Sidebar: #sidebar container not found`);return}r(e),i(e),a(window.location.hash||`#registro-general`)}function r(t){t.innerHTML=`
        <!-- Logo Section -->
