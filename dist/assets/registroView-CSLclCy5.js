import{r as e}from"./parametricaService-CrC5YH-P.js";import{a as t,c as n,d as r,f as i,i as a,l as o,m as s,n as c,o as l,p as u,r as d,u as f}from"./formatter-Cvxt4yKU.js";import{n as p,r as m,t as h}from"./modal-DKrJSUEn.js";function g({containerId:e,columns:t,data:n=[],onView:r,onEdit:i,onDelete:a,footerRow:o=null,emptyMessage:s=`No hay registros disponibles`,disableSorting:c=!1,pageSize:l=50}){let u=document.getElementById(e);if(!u)return console.error(`DataTable: container #${e} not found`),{update(){},destroy(){}};let d=[...n],f=null,p=!0,m=1,h=!c&&!d.some(e=>e.isSubtotal===!0);function g(e){h&&(f===e?p=!p:(f=e,p=!0),d.sort((t,n)=>{let r=t[e]??``,i=n[e]??``;if(typeof r==`number`&&typeof i==`number`)return p?r-i:i-r;let a=String(r).toLowerCase(),o=String(i).toLowerCase();return p?a.localeCompare(o):o.localeCompare(a)}),m=1,v())}function _(e){return h?f===e?p?`<i data-lucide="arrow-up" style="width:14px;height:14px;color:#00b4d8;"></i>`:`<i data-lucide="arrow-down" style="width:14px;height:14px;color:#00b4d8;"></i>`:`<i data-lucide="arrow-up-down" style="width:14px;height:14px;opacity:0.3;"></i>`:``}function v(){if(d.length===0){u.innerHTML=`
        ...
        `:``,b=g.map((e,n)=>{let o=e.isSubtotal===!0,s=p+n,c=t.map(t=>{let n=e[t.key];return t.format&&n!=null&&(n=t.format(n,e)),`<td style="
            ...
            `:``,u=o?`background-color: rgba(148, 163, 184, 0.08); font-weight: bold;`:`transition: background 200ms;`;return e.isContratistaAcumulado&&(u+=` background-color: rgba(255, 209, 102, 0.15);`),`<tr style="${u}" ${o?``:`onmouseenter="this.style.background='var(--bg-hover)'" onmouseleave="this.style.background=''"`}>${c}${l}</tr>`}).join(``),x=``;o&&d.length>0&&(x=`
...
`),i=new Blob([r],{type:`text/csv;charset=utf-8;`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.setAttribute(`href`,a),o.setAttribute(`download`,`registro_sst_export_${new Date().toISOString().slice(0,10)}.csv`),document.body.appendChild(o),o.click(),document.body.removeChild(o)}async function O(e,t=`Directo`){e._currentModo=t,e.innerHTML=`
    <div class="registro-container">
      <div class="registro-header" style="display:flex; flex-direction:column; align-items:stretch; gap:var(--space-4); margin-bottom:var(--space-6); width:100%;">
        ...
        <div style="display:flex; align-items:center; width:100%; gap: 12px; flex-wrap: wrap;">
          ...
          ${t===`Directo`?`<div style="flex:0 1 150px;"><select class="form-select" id="table-filter-anio" style="width:100%; background-color:var(--bg-surface); border:1px solid var(--border-default); padding: 8px 12px; border-radius: 6px; height: 42px;"><option value="">Todos los años</option><option value="2027">2027</option><option value="2026">2026</option><option value="2025">2025</option><option value="2024">2024</option><option value="2023">2023</option></select></div><div style="flex:0 1 150px;"><select class="form-select" id="table-filter-tipo" style="width:100%; background-color:var(--bg-surface); border:1px solid var(--border-default); padding: 8px 12px; border-radius: 6px; height: 42px;"><option value="">Todos los tipos</option><option value="Directo">Directo</option><option value="Contratista">Contratista</option></select></div>`:``}
  ...
  `:``}async function j(t){let[n,r]=await Promise.all([e(`ciudad`),e(`empresa`)]),i=(e,n)=>{let r=t.querySelector(e);r&&n&&n.length>0&&(r.innerHTML=`<option value="" disabled selected>Seleccione...</option>`+n.map(e=>`<option value="${e.valor}">${e.valor}</option>`).join(``))};i(`#input-planta`,n.data),i(`#input-empresa`,r.data)}function M(e,t){let n=e.querySelector(`#input-planta`)?.closest(`.form-group`),r=e.querySelector(`#input-empresa`)?.closest(`.form-group`);if(t===`Directo`){n&&(n.style.display=`block`),r&&(r.style.display=`none`);let t=e.querySelector(`#input-empresa`);t&&(t.value=``)}else{n&&(n.style.display=`none`),r&&(r.style.display=`block`);let t=e.querySelector(`#input-planta`);t&&(t.value=``)}F(e)}function N(e){let t=e.querySelector(`#registro-form`),n=e.querySelector(`#tipo-select`),r=e.querySelector(`#btn-limpiar`),i=e.querySelector(`#btn-nuevo-registro`),a=e.querySelector(`#btn-exportar-csv`),o=e.querySelector(`#btn-volver-tabla`),s=e.querySelector(`#view-table`),c=e.querySelector(`#view-form`),l=e.querySelector(`#table-search-wrapper`),d=e.querySelector(`#table-search-input`),f=()=>{s.style.display=`none`,i.style.display=`none`,a&&(a.style.display=`none`),l&&(l.style.display=`none`),c.style.display=`block`},m=()=>{c.style.display=`none`,s.style.display=`block`,i.style.display=`inline-flex`,a&&(a.style.display=`inline-flex`),l&&(l.style.display=`block`),R(e)};d&&d.addEventListener(`input`,E(()=>{R(e)},300));let h=e.querySelector(`#table-filter-anio`);h&&h.addEventListener(`change`,()=>{R(e)});let g=e.querySelector(`#table-filter-tipo`);g&&g.addEventListener(`change`,()=>{R(e)}),a&&a.addEventListener(`click`,()=>{D(T)}),i.addEventListener(`click`,()=>{I(e),z(e,!1),f()}),o.addEventListener(`click`,()=>{m()}),e._showForm=f,m(),n&&n.addEventListener(`change`,t=>{let n=t.target.value;M(e,n)}),t.querySelectorAll(`input, select`).forEach(t=>{t.addEventListener(`input`,()=>F(e))}),e.querySelectorAll(`.btn-comment`).forEach(t=>{t.addEventListener(`click`,()=>{if(e.querySelector(`#form-fieldset`).disabled)return;let n=t.dataset.key,r=C[n]||``;p({title:`Comentario para ${u(n).label}`,content:`
        ...
        `,confirmText:`Guardar`,cancelText:`Cancelar`}).then(r=>{if(r){let r=document.getElementById(`comment-textarea`),i=r?r.value:``;i.trim()===``?(delete C[n],t.style.color=`var(--text-secondary)`):(C[n]=i.trim(),t.style.color=`var(--danger)`),F(e)}})})}),r.addEventListener(`click`,()=>{I(e)}),t.addEventListener(`submit`,async t=>{t.preventDefault(),await L(e),m()})}function P(e){let t=i(),n=e.querySelector(`#tipo-select`);(n?n.value:`Directo`)===`Contratista`?(t.tipo=`Contratista`,t.empresa=e.querySelector(`#input-empresa`).value||``,t.planta=``):(t.tipo=`Directo`,t.planta=e.querySelector(`#input-planta`).value||``,t.empresa=``);let a=e.querySelector(`#input-periodo`);if(a&&a.value){let[e,n]=a.value.split(`-`);t.anio=parseInt(e,10),t.mes=r[parseInt(n,10)-1]}else t.anio=null,t.mes=null;return t.comentarios=C,f.forEach(n=>{if(n.key!==`tipo`&&n.key!==`comentarios`&&n.key!==`planta`&&n.key!==`empresa`&&n.key!==`anio`&&n.key!==`mes`){let r=e.querySelector(`#input-${n.key}`);if(r)if(r.value===``)t[n.key]=null;else{let e=r.value;n.type===`integer`&&(e=parseInt(e,10)),n.type===`numeric`&&(e=parseFloat(e)),t[n.key]=isNaN(e)?n.type===`select`?r.value:null:e}}}),t}function F(e){let t=s(P(e));o.forEach(n=>{let r=e.querySelector(`#calc-${n.key}`);if(r){let e=``;e=n.key===`proporcion_mortalidad`?d(t[n.key]):n.key===`incidentes_lesiones`||n.key===`total_incidentes`?Math.round(t[n.key]).toString():c(t[n.key]),r.innerText!==e&&(r.innerText=e,r.classList.add(`changed`),setTimeout(()=>r.classList.remove(`changed`),500))}})}function I(e){x=null,C={},e.querySelector(`#registro-form`).reset(),f.forEach(t=>{if(t.key!==`tipo`&&t.key!==`comentarios`){let n=e.querySelector(`#input-${t.key}`);n&&(n.value=``)}}),e.querySelectorAll(`.btn-comment`).forEach(e=>{e.style.color=`var(--color-text-secondary)`});let t=e.querySelector(`#tipo-select`);M(e,t?t.value:`Directo`),e.querySelector(`#btn-guardar`).innerHTML=`<i data-lucide="save"></i> Guardar Registro`,window.lucide&&window.lucide.createIcons(),F(e)}async function L(e){let t=e.querySelector(`#btn-guardar`),r=t.innerHTML;t.innerHTML=`<div class="spinner" style="width:16px;height:16px;border-width:2px;display:inline-block;vertical-align:middle;margin-right:8px"></div> Guardando...`,t.disabled=!0;try{let t=P(e),r;if(r=x?await n(x,t):await a(t),r.error)throw r.error;m(x?`Registro actualizado`:`Registro guardado`,`success`),I(e),await R(e,!0)}catch(e){m(e.message||`Error al guardar`,`error`)}finally{t.innerHTML=r,t.disabled=!1,window.lucide&&window.lucide.createIcons()}}async function R(e,n=!1){let r=e.querySelector(`#table-container`);if(S||(r.innerHTML=`<div class="spinner" style="margin:20px auto"></div>`),n||!w){let e=await l();if(e.error){r.innerHTML=`<p style="color:var(--color-danger)">Error: ${e.error.message}</p>`;return}w=e.data||[]}let i=e._currentModo||`Directo`,a={Enero:1,Febrero:2,Marzo:3,Abril:4,Mayo:5,Junio:6,Julio:7,Agosto:8,Septiembre:9,Octubre:10,Noviembre:11,Diciembre:12},o=(e,t=`Acumulado General`)=>{let n={fai:0,mti:0,mwd:0,lti:0,dp:0,nm:0,hht:0,num_trabajadores:0,fatalidad:0,dias_incapacidad_at_elementia:0,dias_incapacidad_at_ley:0,dias_cargados:0,casos_eg:0,incapacidad_eg:0,casos_el:0};e.forEach(e=>{Object.keys(n).forEach(t=>{n[t]+=Number(e[t])||0})});let r=e.length;n.num_trabajadores=r>0?n.num_trabajadores/r:0;let i=s(n);return{anio:t,mes:`-`,tipo:`-`,planta:`-`,empresa:`-`,num_trabajadores:n.num_trabajadores,hht:n.hht,...n,...i}},u=e.querySelector(`#table-search-input`),f=u?u.value.trim().toLowerCase():``,p=e.querySelector(`#table-filter-anio`),_=e.querySelector(`#table-filter-tipo`),v=p?p.value:``,y=_?_.value:``,b=e=>e.filter(e=>{if(v&&String(e.anio)!==v||y&&String(e.tipo)!==y)return!1;if(f){let t=String(e.anio||``).toLowerCase(),n=String(e.mes||``).toLowerCase(),r=String(e.planta||``).toLowerCase(),i=String(e.empresa||``).toLowerCase(),a=String(e.tipo||``).toLowerCase(),o=`${n} ${t}`;if(!(t.includes(f)||n.includes(f)||r.includes(f)||i.includes(f)||a.includes(f)||o.includes(f)))return!1}return!0});S&&=(S.destroy(),null);let x=[];if(x.push({key:`mes`,label:`PERIODO`,format:(e,t)=>t.isSubtotal?i===`Directo`?`<strong>Acumulado ${t.tipo} ${t.anio}</strong>`:`<strong>Acumulado ${t.mes} ${t.anio}</strong>`:`${t.mes} ${t.anio}`}),i===`Directo`&&x.push({key:`tipo`,label:`TIPO`,width:`160px`,format:(e,t)=>t.isSubtotal?t.tipo===`Contratista`?`<span style="background: rgba(255, 209, 102, 0.15); color: #b08110; padding: 4px 10px; border-radius: 12px; font-size: 11px; font-weight: bold; border: 1px solid rgba(255, 209, 102, 0.4); display: inline-block;">CONTR. ACUM</span>`:`<span style="background: rgba(0, 180, 216, 0.08); color: #00b4d8; padding: 4px 10px; border-radius: 12px; font-size: 11px; font-weight: bold; border: 1px solid rgba(0, 180, 216, 0.2); display: inline-block;">DIR. ACUM</span>`:t.isContratistaAcumulado||t.tipo===`Contratista`?`<span style="background: rgba(255, 209, 102, 0.2); color: #b08110; padding: 4px 10px; border-radius: 12px; font-size: 11px; font-weight: bold; border: 1px solid rgba(255, 209, 102, 0.4); display: inline-block;">CONTRATISTA</span>`:`<span style="background: rgba(0, 180, 216, 0.1); color: #00b4d8; padding: 4px 10px; border-radius: 12px; font-size: 11px; font-weight: bold; border: 1px solid rgba(0, 180, 216, 0.2); display: inline-block;">DIRECTO</span>`}),i===`Contratista`&&x.push({key:`empresa`,label:`EMPRESA`,width:`220px`,format:e=>e||`-`}),x.push({key:`num_trabajadores`,label:`<span title="Trabajadores">TRAB.</span>`},{key:`hht`,label:`HHT`,format:e=>c(e,0)},{key:`incidentes_lesiones`,label:`<span title="Incidentes con Lesión">LESIÓN</span>`,format:e=>c(e,0)},{key:`incidente_tirf`,label:`<span title="Incidentes TIRF">TIRF</span>`,format:e=>c(e,0)},{key:`total_incidentes`,label:`<span title="Total Incidentes">INC.</span>`,format:e=>c(e,0)},{key:`ltif`,label:`<span title="Lost Time Injury Frequency Rate">LTIF</span>`,format:e=>c(e)},{key:`tirf`,label:`<span title="Total Recordable Injury Frequency Rate">TIRF</span>`,format:e=>c(e)},{key:`sr`,label:`<span title="Severity Rate">SR</span>`,format:e=>c(e)},{key:`frecuencia_accidentalidad`,label:`<span title="Frecuencia de Accidentalidad">Frec. Acc.</span>`,format:e=>c(e)},{key:`severidad_accidentalidad`,label:`<span title="Severidad de Accidentalidad">Sev. Acc.</span>`,format:e=>c(e)},{key:`proporcion_mortalidad`,label:`<span title="Proporción de Mortalidad">% Mort.</span>`,format:e=>d(e)}),i===`Directo`){r.innerHTML=``;let n=w.filter(e=>e.tipo===`Directo`).map(e=>({...e,...s(e)})),i={Ene:`Enero`,Jan:`Enero`,Feb:`Febrero`,Mar:`Marzo`,Abr:`Abril`,Apr:`Abril`,May:`Mayo`,Jun:`Junio`,Jul:`Julio`,Ago:`Agosto`,Aug:`Agosto`,Sep:`Septiembre`,Sept:`Septiembre`,Oct:`Octubre`,Nov:`Noviembre`,Dic:`Diciembre`,Dec:`Diciembre`},c=e=>i[e]||e,l=new Set([`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`,`Ene`,`Feb`,`Mar`,`Abr`,`May`,`Jun`,`Jul`,`Ago`,`Sep`,`Sept`,`Oct`,`Nov`,`Dic`]),u=w.filter(e=>e.tipo===`Contratista`&&e.mes&&l.has(e.mes)),d={};u.forEach(e=>{let t=c(e.mes),n=`${e.anio}__${t}`;d[n]||(d[n]={isContratistaAcumulado:!0,readonlyAction:!0,anio:e.anio,mes:t,tipo:`Contratista`,planta:`-`,empresa:`Acumulado`,num_trabajadores:0,hht:0,dp:0,nm:0,fai:0,mti:0,mwd:0,lti:0,fatalidad:0,dias_incapacidad_at_elementia:0,dias_incapacidad_at_ley:0,dias_cargados:0,casos_eg:0,incapacidad_eg:0,casos_el:0});let r=d[n];[`num_trabajadores`,`hht`,`dp`,`nm`,`fai`,`mti`,`mwd`,`lti`,`fatalidad`,`dias_incapacidad_at_elementia`,`dias_incapacidad_at_ley`,`dias_cargados`,`casos_eg`,`incapacidad_eg`,`casos_el`].forEach(t=>{r[t]+=Number(e[t])||0})});let p=Object.values(d).map(e=>({...e,...s(e)})),_=[...new Set([...n.map(e=>e.anio),...p.map(e=>e.anio)])].sort((e,t)=>t-e),C=(e,t,n)=>{let r=e.filter(e=>e.anio===t);if(r.length===0)return null;let i={fai:0,mti:0,mwd:0,lti:0,dp:0,nm:0,hht:0,num_trabajadores:0,fatalidad:0,dias_incapacidad_at_elementia:0,dias_incapacidad_at_ley:0,dias_cargados:0,casos_eg:0,incapacidad_eg:0,casos_el:0};r.forEach(e=>{Object.keys(i).forEach(t=>{i[t]+=Number(e[t])||0})}),i.num_trabajadores=r.length>0?i.num_trabajadores/r.length:0;let a=s(i);return{isSubtotal:!0,isContratistaAcumulado:n===`Contratista`,readonlyAction:!0,anio:t,mes:`Acumulado`,tipo:n,planta:`-`,empresa:`Acumulado`,...i,...a}},E=[];_.forEach(e=>{let t=n.filter(t=>t.anio===e).sort((e,t)=>(a[e.mes]??99)-(a[t.mes]??99));if(t.length>0){E.push(...t);let r=C(n,e,`Directo`);r&&E.push(r)}let r=p.filter(t=>t.anio===e).sort((e,t)=>(a[e.mes]??99)-(a[t.mes]??99));if(r.length>0){E.push(...r);let t=C(p,e,`Contratista`);t&&E.push(t)}});let D=b([...n,...p]),O=E;if(v||y||f){let e=new Set(D.map(e=>e.isContratistaAcumulado?`C__${e.anio}__${e.mes}`:`D__${e.id}`));O=E.filter(t=>{if(t.isSubtotal)return!0;let n=t.isContratistaAcumulado?`C__${t.anio}__${t.mes}`:`D__${t.id}`;return e.has(n)})}let k=o(D,`Acumulado General`);T=D,S=g({containerId:`table-container`,columns:x,data:O,footerRow:k,onView:t=>{t.isContratistaAcumulado||t.isSubtotal||(B(e,t),z(e,!0),e._showForm())},onEdit:t=>{if(t.isContratistaAcumulado||t.isSubtotal||t.tipo!==`Directo`){m(`No se puede editar un registro de contratistas desde esta vista`,`warning`);return}B(e,t),z(e,!1),e._showForm()},onDelete:async n=>{if(n.isContratistaAcumulado||n.isSubtotal||n.tipo!==`Directo`){m(`No se puede eliminar un registro de contratistas desde esta vista`,`warning`);return}await h(`Eliminar`,`\u00bfSeguro que desea eliminar el registro de ${n.mes} ${n.anio}?`)&&((await t(n.id)).error?m(`Error al eliminar`,`error`):(m(`Registro eliminado`,`success`),await R(e,!0)))},emptyMessage:`No hay registros guardados.`})}else{r.innerHTML=``;let n=b(w.filter(e=>e.tipo===`Contratista`).map(e=>({...e,...s(e)})));T=n,n.sort((e,t)=>{if(t.anio!==e.anio)return t.anio-e.anio;let n=a[e.mes]??99,r=a[t.mes]??99;return r===n?(e.empresa||``).localeCompare(t.empresa||``):r-n});let i=(e,t,n)=>{let r={fai:0,mti:0,mwd:0,lti:0,dp:0,nm:0,hht:0,num_trabajadores:0,fatalidad:0,dias_incapacidad_at_elementia:0,dias_incapacidad_at_ley:0,dias_cargados:0,casos_eg:0,incapacidad_eg:0,casos_el:0};e.forEach(e=>{Object.keys(r).forEach(t=>{r[t]+=Number(e[t])||0})});let i=s(r);return{isSubtotal:!0,anio:t,mes:n,tipo:`-`,planta:`-`,empresa:`Acumulado`,num_trabajadores:r.num_trabajadores,hht:r.hht,...r,...i}},c=[],l=[],u=null,d=null;n.forEach(e=>{e.anio!==u||e.mes!==d?(l.length>0&&(c.push(...l),l.length>=1&&c.push(i(l,u,d))),l=[e],u=e.anio,d=e.mes):l.push(e)}),l.length>0&&(c.push(...l),l.length>=1&&c.push(i(l,u,d))),S=g({containerId:`table-container`,columns:x,data:c,footerRow:o(n,`Acumulado General Contratistas`),onView:t=>{B(e,t),z(e,!0),e._showForm()},onEdit:t=>{B(e,t),z(e,!1),e._showForm()},onDelete:async n=>{await h(`Eliminar`,`¿Seguro que desea eliminar el registro de ${n.mes} ${n.anio}?`)&&((await t(n.id)).error?m(`Error al eliminar`,`error`):(m(`Registro eliminado`,`success`),await R(e,!0)))},emptyMessage:`No hay registros guardados para contratistas.`})}}function z(e,t){let n=e.querySelector(`#form-fieldset`),r=e.querySelector(`#form-actions-container`);n&&(n.disabled=t),r&&(r.style.display=t?`none`:`flex`)}function B(e,t){x=t.id,C=t.comentarios||{};let n=t.tipo===`Directo`;if(e.querySelector(`#tipo-select`).value=n?`Directo`:`Contratista`,M(e,n?`Directo`:`Contratista`),n?t.planta&&(e.querySelector(`#input-planta`).value=t.planta):t.empresa&&(e.querySelector(`#input-empresa`).value=t.empresa),t.anio&&t.mes){let n=r.indexOf(t.mes);if(n!==-1){let r=(n+1).toString().padStart(2,`0`);e.querySelector(`#input-periodo`).value=`${t.anio}-${r}`}}else e.querySelector(`#input-periodo`).value=``;f.forEach(n=>{if(n.key!==`tipo`&&n.key!==`comentarios`&&n.key!==`planta`&&n.key!==`empresa`&&n.key!==`anio`&&n.key!==`mes`){let r=e.querySelector(`#input-${n.key}`);r&&t[n.key]!==void 0&&t[n.key]!==null?r.value=t[n.key]:r&&(r.value=``)}}),e.querySelectorAll(`.btn-comment`).forEach(e=>{let t=e.dataset.key;C[t]?e.style.color=`var(--danger)`:e.style.color=`var(--text-secondary)`}),F(e),e.querySelector(`#btn-guardar`).innerHTML=`<i data-lucide="edit"></i> Actualizar Registro`,window.lucide&&window.lucide.createIcons(),window.scrollTo({top:0,behavior:`smooth`})}export{O as renderRegistro};